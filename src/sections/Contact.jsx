      ...
      <div className="grid md:grid-cols-2 h-full w-full md:mr-[-30px]">
        <div className="flex flex-col w-full md:pr-[16px] gap-[24px] md:justify-between">
          <p className="uppercase text-[24px] leading-[32px] md:text-[38px] md:leading-[46px] neue-bold ">
            Share your vision — <br /> we&apos;ll shape it together
          </p>
          <div className="flex flex-col gap-[16px] ">
            <div className="flex flex-col md:flex-row gap-[16px]">
              <input type="text" placeholder="Your name*" className="bg-black w-full rounded-md h-[40px] text-white px-[16px] " />
              <input type="mail" placeholder="Your email*" className="bg-black w-full rounded-md h-[40px] text-white px-[16px] " />
            </div>
            ...
            <textarea name="" id="" rows="8" placeholder="I want to build my ....*" className="bg-black rounded-lg text-white px-[16px] pt-[10px] resize-none"></textarea>
            <button className="bg-black text-white rounded-md">
              <div className="flex flex-row justify-center items-center gap-[8px] ">
                <span className="neue-medium">Send</span>
                <div className="size-[20px] bg-white rounded-md "></div>
              </div>
            </button>
            <span>We usually reply in 24 hours.</span>
          </div>
        </div>
